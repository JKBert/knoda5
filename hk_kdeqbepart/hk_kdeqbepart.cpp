...
K_EXPORT_PLUGIN(hk_kdeqbepartfactory("hk_kde4qbepart","hk_kde4qbepart"))
...
//    p_private->p_qbe->p_part=this;
    ...
    loader->addAppDir("hk_kde4classes");
     setXMLFile(KStandardDirs::locate("data","hk_kde4classes/hk_kdeqbepart.rc"));
...
{
    KAboutData* a= new KAboutData("hk_kde4qbepart", "hk_kde4qbepart",ki18n("hk_kde4qbepart"),
