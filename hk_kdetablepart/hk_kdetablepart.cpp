...
K_EXPORT_PLUGIN(hk_kdetablepartfactory("hk_kde4tablepart","hk_kde4tablepart"))
...
:KParts::ReadWritePart(parent)
{
    ...
    loader->addAppDir("hk_kde4classes");
     ...
     setXMLFile(KStandardDirs::locate("data","hk_kde4classes/hk_kdetablepart.rc"));
...
{
    KAboutData* a= new KAboutData("hk_kde4tablepart", "hk_kde4tablepart",ki18n("hk_kde4tablepart"),
